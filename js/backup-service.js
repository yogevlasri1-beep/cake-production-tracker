...
} from './backup.js?v=436';
import { downloadBlob } from './download.js?v=436';
import { ValidationError } from './validators.js?v=436';
import { openModal, closeModal } from './modal.js?v=436';
import { escapeHtml, showToast } from './utils.js?v=436';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=436';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=436');
