...
} from './backup.js?v=435';
import { downloadBlob } from './download.js?v=435';
import { ValidationError } from './validators.js?v=435';
import { openModal, closeModal } from './modal.js?v=435';
import { escapeHtml, showToast } from './utils.js?v=435';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=435';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=435');
