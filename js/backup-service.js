...
} from './backup.js?v=405';
import { downloadBlob } from './download.js?v=405';
import { ValidationError } from './validators.js?v=405';
import { openModal, closeModal } from './modal.js?v=405';
import { escapeHtml, showToast } from './utils.js?v=405';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=405';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=405');
