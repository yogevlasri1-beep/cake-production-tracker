...
} from './backup.js?v=484';
import { downloadBlob } from './download.js?v=484';
import { ValidationError } from './validators.js?v=484';
import { openModal, closeModal } from './modal.js?v=484';
import { escapeHtml, showToast } from './utils.js?v=484';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=484';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=484');
