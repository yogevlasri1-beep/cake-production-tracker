...
} from './backup.js?v=421';
import { downloadBlob } from './download.js?v=421';
import { ValidationError } from './validators.js?v=421';
import { openModal, closeModal } from './modal.js?v=421';
import { escapeHtml, showToast } from './utils.js?v=421';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=421';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=421');
