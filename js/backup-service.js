...
} from './backup.js?v=404';
import { downloadBlob } from './download.js?v=404';
import { ValidationError } from './validators.js?v=404';
import { openModal, closeModal } from './modal.js?v=404';
import { escapeHtml, showToast } from './utils.js?v=404';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=404';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=404');
