...
} from './backup.js?v=476';
import { downloadBlob } from './download.js?v=476';
import { ValidationError } from './validators.js?v=476';
import { openModal, closeModal } from './modal.js?v=476';
import { escapeHtml, showToast } from './utils.js?v=476';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=476';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=476');
