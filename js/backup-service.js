...
} from './backup.js?v=471';
import { downloadBlob } from './download.js?v=471';
import { ValidationError } from './validators.js?v=471';
import { openModal, closeModal } from './modal.js?v=471';
import { escapeHtml, showToast } from './utils.js?v=471';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=471';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=471');
