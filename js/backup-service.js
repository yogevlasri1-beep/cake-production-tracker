...
} from './backup.js?v=406';
import { downloadBlob } from './download.js?v=406';
import { ValidationError } from './validators.js?v=406';
import { openModal, closeModal } from './modal.js?v=406';
import { escapeHtml, showToast } from './utils.js?v=406';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=406';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=406');
