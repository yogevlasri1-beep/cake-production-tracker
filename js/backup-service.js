...
} from './backup.js?v=460';
import { downloadBlob } from './download.js?v=460';
import { ValidationError } from './validators.js?v=460';
import { openModal, closeModal } from './modal.js?v=460';
import { escapeHtml, showToast } from './utils.js?v=460';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=460';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=460');
