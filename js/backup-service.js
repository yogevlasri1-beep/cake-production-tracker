...
} from './backup.js?v=359';
import { downloadBlob } from './download.js?v=359';
import { ValidationError } from './validators.js?v=359';
import { openModal, closeModal } from './modal.js?v=359';
import { escapeHtml, showToast } from './utils.js?v=359';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=359';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=359');
