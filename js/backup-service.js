...
} from './backup.js?v=438';
import { downloadBlob } from './download.js?v=438';
import { ValidationError } from './validators.js?v=438';
import { openModal, closeModal } from './modal.js?v=438';
import { escapeHtml, showToast } from './utils.js?v=438';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=438';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=438');
