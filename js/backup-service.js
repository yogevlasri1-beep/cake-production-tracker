...
} from './backup.js?v=419';
import { downloadBlob } from './download.js?v=419';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=419';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=419');
