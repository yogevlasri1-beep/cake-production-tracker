...
} from './backup.js?v=388';
import { downloadBlob } from './download.js?v=388';
import { ValidationError } from './validators.js?v=388';
import { openModal, closeModal } from './modal.js?v=388';
import { escapeHtml, showToast } from './utils.js?v=388';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=388';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=388');
