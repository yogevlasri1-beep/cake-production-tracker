...
} from './backup.js?v=378';
import { downloadBlob } from './download.js?v=378';
import { ValidationError } from './validators.js?v=378';
import { openModal, closeModal } from './modal.js?v=378';
import { escapeHtml, showToast } from './utils.js?v=378';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=378';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=378');
