...
} from './backup.js?v=444';
import { downloadBlob } from './download.js?v=444';
import { ValidationError } from './validators.js?v=444';
import { openModal, closeModal } from './modal.js?v=444';
import { escapeHtml, showToast } from './utils.js?v=444';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=444';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=444');
