...
} from './backup.js?v=424';
import { downloadBlob } from './download.js?v=424';
import { ValidationError } from './validators.js?v=424';
import { openModal, closeModal } from './modal.js?v=424';
import { escapeHtml, showToast } from './utils.js?v=424';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=424';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=424');
