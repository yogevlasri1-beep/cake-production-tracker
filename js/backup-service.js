...
} from './backup.js?v=382';
import { downloadBlob } from './download.js?v=382';
import { ValidationError } from './validators.js?v=382';
import { openModal, closeModal } from './modal.js?v=382';
import { escapeHtml, showToast } from './utils.js?v=382';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=382';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=382');
