...
} from './backup.js?v=387';
import { downloadBlob } from './download.js?v=387';
import { ValidationError } from './validators.js?v=387';
import { openModal, closeModal } from './modal.js?v=387';
import { escapeHtml, showToast } from './utils.js?v=387';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=387';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=387');
