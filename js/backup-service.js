...
} from './backup.js?v=370';
import { downloadBlob } from './download.js?v=370';
import { ValidationError } from './validators.js?v=370';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=370';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=370');
