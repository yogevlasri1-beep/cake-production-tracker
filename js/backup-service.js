...
} from './backup.js?v=354';
import { downloadBlob } from './download.js?v=354';
import { ValidationError } from './validators.js?v=354';
import { openModal, closeModal } from './modal.js?v=354';
import { escapeHtml, showToast } from './utils.js?v=354';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=354';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=354');
