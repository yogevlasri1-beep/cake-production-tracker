...
} from './backup.js?v=472';
import { downloadBlob } from './download.js?v=472';
import { ValidationError } from './validators.js?v=472';
import { openModal, closeModal } from './modal.js?v=472';
import { escapeHtml, showToast } from './utils.js?v=472';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=472';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=472');
