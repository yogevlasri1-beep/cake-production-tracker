...
} from './backup.js?v=374';
import { downloadBlob } from './download.js?v=374';
import { ValidationError } from './validators.js?v=374';
import { openModal, closeModal } from './modal.js?v=374';
import { escapeHtml, showToast } from './utils.js?v=374';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=374';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=374');
