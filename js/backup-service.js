...
} from './backup.js?v=456';
import { downloadBlob } from './download.js?v=456';
import { ValidationError } from './validators.js?v=456';
import { openModal, closeModal } from './modal.js?v=456';
import { escapeHtml, showToast } from './utils.js?v=456';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=456';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=456');
