...
} from './backup.js?v=373';
import { downloadBlob } from './download.js?v=373';
import { ValidationError } from './validators.js?v=373';
import { openModal, closeModal } from './modal.js?v=373';
import { escapeHtml, showToast } from './utils.js?v=373';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=373';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=373');
