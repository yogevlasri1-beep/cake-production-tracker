...
} from './backup.js?v=485';
import { downloadBlob } from './download.js?v=485';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=485';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=485');
