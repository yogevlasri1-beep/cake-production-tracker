...
} from './backup.js?v=420';
import { downloadBlob } from './download.js?v=420';
import { ValidationError } from './validators.js?v=420';
import { openModal, closeModal } from './modal.js?v=420';
import { escapeHtml, showToast } from './utils.js?v=420';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=420';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=420');
