...
} from './backup.js?v=355';
import { downloadBlob } from './download.js?v=355';
import { ValidationError } from './validators.js?v=355';
import { openModal, closeModal } from './modal.js?v=355';
import { escapeHtml, showToast } from './utils.js?v=355';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=355';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=355');
