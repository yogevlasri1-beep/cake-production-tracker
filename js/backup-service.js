...
} from './backup.js?v=389';
import { downloadBlob } from './download.js?v=389';
import { ValidationError } from './validators.js?v=389';
import { openModal, closeModal } from './modal.js?v=389';
import { escapeHtml, showToast } from './utils.js?v=389';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=389';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=389');
