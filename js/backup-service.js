...
} from './backup.js?v=402';
import { downloadBlob } from './download.js?v=402';
import { ValidationError } from './validators.js?v=402';
import { openModal, closeModal } from './modal.js?v=402';
import { escapeHtml, showToast } from './utils.js?v=402';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=402';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=402');
