...
} from './backup.js?v=363';
import { downloadBlob } from './download.js?v=363';
import { ValidationError } from './validators.js?v=363';
import { openModal, closeModal } from './modal.js?v=363';
import { escapeHtml, showToast } from './utils.js?v=363';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=363';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=363');
