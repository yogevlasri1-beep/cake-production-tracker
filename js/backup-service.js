...
} from './backup.js?v=375';
import { downloadBlob } from './download.js?v=375';
import { ValidationError } from './validators.js?v=375';
import { openModal, closeModal } from './modal.js?v=375';
import { escapeHtml, showToast } from './utils.js?v=375';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=375';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=375');
