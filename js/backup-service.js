...
} from './backup.js?v=473';
import { downloadBlob } from './download.js?v=473';
import { ValidationError } from './validators.js?v=473';
import { openModal, closeModal } from './modal.js?v=473';
import { escapeHtml, showToast } from './utils.js?v=473';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=473';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=473');
