...
} from './backup.js?v=410';
import { downloadBlob } from './download.js?v=410';
import { ValidationError } from './validators.js?v=410';
import { openModal, closeModal } from './modal.js?v=410';
import { escapeHtml, showToast } from './utils.js?v=410';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=410';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=410');
