...
} from './backup.js?v=418';
import { downloadBlob } from './download.js?v=418';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=418';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=418');
