...
} from './backup.js?v=470';
import { downloadBlob } from './download.js?v=470';
import { ValidationError } from './validators.js?v=470';
import { openModal, closeModal } from './modal.js?v=470';
import { escapeHtml, showToast } from './utils.js?v=470';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=470';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=470');
