...
} from './backup.js?v=459';
import { downloadBlob } from './download.js?v=459';
import { ValidationError } from './validators.js?v=459';
import { openModal, closeModal } from './modal.js?v=459';
import { escapeHtml, showToast } from './utils.js?v=459';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=459';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=459');
