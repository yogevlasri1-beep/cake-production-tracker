...
} from './backup.js?v=407';
import { downloadBlob } from './download.js?v=407';
import { ValidationError } from './validators.js?v=407';
import { openModal, closeModal } from './modal.js?v=407';
import { escapeHtml, showToast } from './utils.js?v=407';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=407';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=407');
