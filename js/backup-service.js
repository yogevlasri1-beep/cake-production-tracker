...
} from './backup.js?v=403';
import { downloadBlob } from './download.js?v=403';
import { ValidationError } from './validators.js?v=403';
import { openModal, closeModal } from './modal.js?v=403';
import { escapeHtml, showToast } from './utils.js?v=403';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=403';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=403');
