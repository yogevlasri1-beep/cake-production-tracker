...
} from './backup.js?v=356';
import { downloadBlob } from './download.js?v=356';
import { ValidationError } from './validators.js?v=356';
import { openModal, closeModal } from './modal.js?v=356';
import { escapeHtml, showToast } from './utils.js?v=356';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=356';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=356');
