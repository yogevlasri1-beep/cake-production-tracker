...
} from './backup.js?v=386';
import { downloadBlob } from './download.js?v=386';
import { ValidationError } from './validators.js?v=386';
import { openModal, closeModal } from './modal.js?v=386';
import { escapeHtml, showToast } from './utils.js?v=386';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=386';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=386');
