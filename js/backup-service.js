...
} from './backup.js?v=379';
import { downloadBlob } from './download.js?v=379';
import { ValidationError } from './validators.js?v=379';
import { openModal, closeModal } from './modal.js?v=379';
import { escapeHtml, showToast } from './utils.js?v=379';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=379';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=379');
