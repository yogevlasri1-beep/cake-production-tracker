...
} from './backup.js?v=390';
import { downloadBlob } from './download.js?v=390';
import { ValidationError } from './validators.js?v=390';
import { openModal, closeModal } from './modal.js?v=390';
import { escapeHtml, showToast } from './utils.js?v=390';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=390';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=390');
