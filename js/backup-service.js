...
} from './backup.js?v=437';
import { downloadBlob } from './download.js?v=437';
import { ValidationError } from './validators.js?v=437';
import { openModal, closeModal } from './modal.js?v=437';
import { escapeHtml, showToast } from './utils.js?v=437';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=437';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=437');
