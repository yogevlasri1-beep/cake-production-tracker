...
} from './backup.js?v=432';
import { downloadBlob } from './download.js?v=432';
import { ValidationError } from './validators.js?v=432';
import { openModal, closeModal } from './modal.js?v=432';
import { escapeHtml, showToast } from './utils.js?v=432';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=432';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=432');
