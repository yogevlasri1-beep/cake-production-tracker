...
} from './backup.js?v=443';
import { downloadBlob } from './download.js?v=443';
import { ValidationError } from './validators.js?v=443';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=443';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=443');
