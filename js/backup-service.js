...
} from './backup.js?v=441';
import { downloadBlob } from './download.js?v=441';
import { ValidationError } from './validators.js?v=441';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=441';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=441');
