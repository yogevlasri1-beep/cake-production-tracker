...
} from './backup.js?v=383';
import { downloadBlob } from './download.js?v=383';
import { ValidationError } from './validators.js?v=383';
import { openModal, closeModal } from './modal.js?v=383';
import { escapeHtml, showToast } from './utils.js?v=383';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=383';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=383');
