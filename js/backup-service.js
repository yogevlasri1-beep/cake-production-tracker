...
} from './backup.js?v=412';
import { downloadBlob } from './download.js?v=412';
import { ValidationError } from './validators.js?v=412';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=412';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=412');
