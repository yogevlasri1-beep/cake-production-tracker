...
} from './backup.js?v=367';
import { downloadBlob } from './download.js?v=367';
import { ValidationError } from './validators.js?v=367';
import { openModal, closeModal } from './modal.js?v=367';
import { escapeHtml, showToast } from './utils.js?v=367';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=367';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=367');
