...
} from './backup.js?v=451';
import { downloadBlob } from './download.js?v=451';
import { ValidationError } from './validators.js?v=451';
import { openModal, closeModal } from './modal.js?v=451';
import { escapeHtml, showToast } from './utils.js?v=451';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=451';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=451');
