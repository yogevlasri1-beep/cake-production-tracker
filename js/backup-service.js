...
} from './backup.js?v=475';
import { downloadBlob } from './download.js?v=475';
import { ValidationError } from './validators.js?v=475';
import { openModal, closeModal } from './modal.js?v=475';
import { escapeHtml, showToast } from './utils.js?v=475';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=475';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=475');
