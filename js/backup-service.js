...
} from './backup.js?v=391';
import { downloadBlob } from './download.js?v=391';
import { ValidationError } from './validators.js?v=391';
import { openModal, closeModal } from './modal.js?v=391';
import { escapeHtml, showToast } from './utils.js?v=391';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=391';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=391');
