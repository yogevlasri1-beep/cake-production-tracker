...
} from './backup.js?v=429';
import { downloadBlob } from './download.js?v=429';
import { ValidationError } from './validators.js?v=429';
import { openModal, closeModal } from './modal.js?v=429';
import { escapeHtml, showToast } from './utils.js?v=429';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=429';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=429');
