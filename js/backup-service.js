...
} from './backup.js?v=395';
import { downloadBlob } from './download.js?v=395';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=395';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=395');
