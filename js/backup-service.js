...
} from './backup.js?v=372';
import { downloadBlob } from './download.js?v=372';
import { ValidationError } from './validators.js?v=372';
import { openModal, closeModal } from './modal.js?v=372';
import { escapeHtml, showToast } from './utils.js?v=372';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=372';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=372');
