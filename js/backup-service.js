...
} from './backup.js?v=430';
import { downloadBlob } from './download.js?v=430';
import { ValidationError } from './validators.js?v=430';
import { openModal, closeModal } from './modal.js?v=430';
import { escapeHtml, showToast } from './utils.js?v=430';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=430';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=430');
