...
} from './backup.js?v=446';
import { downloadBlob } from './download.js?v=446';
import { ValidationError } from './validators.js?v=446';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=446';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=446');
