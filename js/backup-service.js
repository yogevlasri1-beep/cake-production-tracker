...
} from './backup.js?v=431';
import { downloadBlob } from './download.js?v=431';
import { ValidationError } from './validators.js?v=431';
import { openModal, closeModal } from './modal.js?v=431';
import { escapeHtml, showToast } from './utils.js?v=431';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=431';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=431');
