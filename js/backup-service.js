...
} from './backup.js?v=434';
import { downloadBlob } from './download.js?v=434';
import { ValidationError } from './validators.js?v=434';
import { openModal, closeModal } from './modal.js?v=434';
import { escapeHtml, showToast } from './utils.js?v=434';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=434';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=434');
