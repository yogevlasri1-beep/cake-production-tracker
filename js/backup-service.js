...
} from './backup.js?v=425';
import { downloadBlob } from './download.js?v=425';
import { ValidationError } from './validators.js?v=425';
import { openModal, closeModal } from './modal.js?v=425';
import { escapeHtml, showToast } from './utils.js?v=425';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=425';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=425');
