...
} from './backup.js?v=474';
import { downloadBlob } from './download.js?v=474';
import { ValidationError } from './validators.js?v=474';
import { openModal, closeModal } from './modal.js?v=474';
import { escapeHtml, showToast } from './utils.js?v=474';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=474';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=474');
