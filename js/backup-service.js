...
} from './backup.js?v=439';
import { downloadBlob } from './download.js?v=439';
import { ValidationError } from './validators.js?v=439';
import { openModal, closeModal } from './modal.js?v=439';
import { escapeHtml, showToast } from './utils.js?v=439';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=439';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=439');
