...
} from './backup.js?v=371';
import { downloadBlob } from './download.js?v=371';
import { ValidationError } from './validators.js?v=371';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=371';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=371');
