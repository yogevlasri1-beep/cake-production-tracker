...
} from './backup.js?v=440';
import { downloadBlob } from './download.js?v=440';
import { ValidationError } from './validators.js?v=440';
import { openModal, closeModal } from './modal.js?v=440';
import { escapeHtml, showToast } from './utils.js?v=440';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=440';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=440');
