...
} from './backup.js?v=455';
import { downloadBlob } from './download.js?v=455';
import { ValidationError } from './validators.js?v=455';
import { openModal, closeModal } from './modal.js?v=455';
import { escapeHtml, showToast } from './utils.js?v=455';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=455';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=455');
