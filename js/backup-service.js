...
} from './backup.js?v=426';
import { downloadBlob } from './download.js?v=426';
import { ValidationError } from './validators.js?v=426';
import { openModal, closeModal } from './modal.js?v=426';
import { escapeHtml, showToast } from './utils.js?v=426';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=426';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=426');
