...
} from './backup.js?v=380';
import { downloadBlob } from './download.js?v=380';
import { ValidationError } from './validators.js?v=380';
import { openModal, closeModal } from './modal.js?v=380';
import { escapeHtml, showToast } from './utils.js?v=380';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=380';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=380');
