...
} from './backup.js?v=392';
import { downloadBlob } from './download.js?v=392';
import { ValidationError } from './validators.js?v=392';
import { openModal, closeModal } from './modal.js?v=392';
import { escapeHtml, showToast } from './utils.js?v=392';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=392';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=392');
