...
} from './backup.js?v=433';
import { downloadBlob } from './download.js?v=433';
import { ValidationError } from './validators.js?v=433';
import { openModal, closeModal } from './modal.js?v=433';
import { escapeHtml, showToast } from './utils.js?v=433';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=433';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=433');
