...
} from './backup.js?v=422';
import { downloadBlob } from './download.js?v=422';
import { ValidationError } from './validators.js?v=422';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=422';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=422');
