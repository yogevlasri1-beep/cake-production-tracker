...
} from './backup.js?v=445';
import { downloadBlob } from './download.js?v=445';
import { ValidationError } from './validators.js?v=445';
...
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=445';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=445');
