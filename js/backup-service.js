...
} from './backup.js?v=449';
import { downloadBlob } from './download.js?v=449';
import { ValidationError } from './validators.js?v=449';
import { openModal, closeModal } from './modal.js?v=449';
import { escapeHtml, showToast } from './utils.js?v=449';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=449';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=449');
