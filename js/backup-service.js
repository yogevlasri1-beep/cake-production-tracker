...
} from './backup.js?v=428';
import { downloadBlob } from './download.js?v=428';
import { ValidationError } from './validators.js?v=428';
import { openModal, closeModal } from './modal.js?v=428';
import { escapeHtml, showToast } from './utils.js?v=428';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=428';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=428');
