...
} from './backup.js?v=381';
import { downloadBlob } from './download.js?v=381';
import { ValidationError } from './validators.js?v=381';
import { openModal, closeModal } from './modal.js?v=381';
import { escapeHtml, showToast } from './utils.js?v=381';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=381';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=381');
