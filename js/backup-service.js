...
} from './backup.js?v=423';
import { downloadBlob } from './download.js?v=423';
import { ValidationError } from './validators.js?v=423';
import { openModal, closeModal } from './modal.js?v=423';
import { escapeHtml, showToast } from './utils.js?v=423';
import {
  ...
  isNativeApp,
} from './backup-folder-bridge.js?v=423';
import {
...
export async function getBackupStatus() {
  ...
  let liveSync = null;
  try {
    const { getLiveSyncStatus } = await import('./supabase-sync.js?v=423');
