import { escapeHtml, formatDecimal } from './utils.js?v=445';
import { openBarcodeScanner } from './barcode-scan.js?v=445';
...
export async function bindLotPickerFields(root) {
  ...
  if (materialIds.length) {
    ({ listActiveLots } = await import('./inventory-db.js?v=445'));
  }
