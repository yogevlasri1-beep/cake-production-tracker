import { db, ValidationError } from './db.js?v=458';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=458';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=458');
    return {
