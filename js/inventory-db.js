import { db, ValidationError } from './db.js?v=484';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=484';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=484');
    return {
