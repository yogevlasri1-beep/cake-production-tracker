import { db, ValidationError } from './db.js?v=438';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=438';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=438');
    return {
