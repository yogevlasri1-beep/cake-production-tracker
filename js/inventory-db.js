import { db, ValidationError } from './db.js?v=443';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=443';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=443');
    return {
