import { db, ValidationError } from './db.js?v=465';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=465';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=465');
    return {
