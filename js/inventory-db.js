import { db, ValidationError } from './db.js?v=453';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=453';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=453');
    return {
