import { db, ValidationError } from './db.js?v=462';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=462';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=462');
    return {
