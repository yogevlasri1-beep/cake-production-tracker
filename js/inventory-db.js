import { db, ValidationError } from './db.js?v=452';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=452';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=452');
    return {
