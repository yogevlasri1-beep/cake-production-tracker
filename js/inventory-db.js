import { db, ValidationError } from './db.js?v=470';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=470';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=470');
    return {
