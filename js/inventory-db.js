import { db, ValidationError } from './db.js?v=466';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=466';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=466');
    return {
