import { db, ValidationError } from './db.js?v=472';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=472';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=472');
    return {
