import { db, ValidationError } from './db.js?v=467';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=467';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=467');
    return {
