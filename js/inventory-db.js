import { db, ValidationError } from './db.js?v=461';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=461';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=461');
    return {
