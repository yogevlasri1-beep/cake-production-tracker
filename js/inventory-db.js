import { db, ValidationError } from './db.js?v=471';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=471';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=471');
    return {
