import { db, ValidationError } from './db.js?v=434';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=434';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=434');
    return {
