import { db, ValidationError } from './db.js?v=483';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=483';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=483');
    return {
