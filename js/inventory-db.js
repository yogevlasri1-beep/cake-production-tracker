import { db, ValidationError } from './db.js?v=464';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=464';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=464');
    return {
