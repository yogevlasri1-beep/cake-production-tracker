import { db, ValidationError } from './db.js?v=441';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=441';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=441');
    return {
