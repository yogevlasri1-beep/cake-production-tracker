import { db, ValidationError } from './db.js?v=469';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=469';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=469');
    return {
