import { db, ValidationError } from './db.js?v=480';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=480';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=480');
    return {
