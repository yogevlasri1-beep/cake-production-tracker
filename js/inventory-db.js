import { db, ValidationError } from './db.js?v=463';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=463';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=463');
    return {
