import { db, ValidationError } from './db.js?v=451';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=451';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=451');
    return {
