import { db, ValidationError } from './db.js?v=476';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=476';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=476');
    return {
