import { db, ValidationError } from './db.js?v=437';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=437';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=437');
    return {
