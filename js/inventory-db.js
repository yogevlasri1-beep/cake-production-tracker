import { db, ValidationError } from './db.js?v=475';
import {
  getRawMaterials,
...
import { localDateTimeISO, roundDecimal } from './utils.js?v=475';
...
async function currentUserStamp() {
  try {
    const { getCurrentUserEmail, getCurrentUserDisplayName } = await import('./auth.js?v=475');
    return {
