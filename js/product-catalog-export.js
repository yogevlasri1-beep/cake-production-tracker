...
import { escapeHtml, formatMoney, productPriceUnitLabel } from './utils.js?v=474';
import { buildStandaloneReportHtml, saveReportPageAsHtml } from './report-page-export.js?v=474';
import { loadXLSX } from './xlsx-loader.js?v=474';
import {
  formatCatalogAllergens,
  formatCatalogPrice,
  formatCatalogWeight,
  isProductInCatalog,
} from './product-catalog.js?v=474';
