 ...
 */
import { db, getSetting, setSetting } from './db.js?v=479';
import {
...
} from './sync/collections.js?v=479';
import {
  ensureSyncId,
  getMetaByLocal,
  getMetaBySyncId,
  ...
  remapFksToSyncIds,
  upsertMeta,
} from './sync/id-map.js?v=479';
import { repairRecipeProductLinksFromComposition, ensureRoleSupplierCategories, inferRawMaterialSupplierRole, coerceSupplierNumericFks, reconcileRawMaterialPricesFromHistory } from './kitchen-db.js?v=479';
import {
...
export async function haltLiveSyncForAuth() {
  ...
  try {
    const { showToast } = await import('./utils.js?v=479');
