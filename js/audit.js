...
import { getValidSession } from './auth.js?v=417';
import { getSupabaseBackupConfig, buildSupabaseRestUrl, getOrCreateDeviceId, getBackupScopeId } from './supabase-backup.js?v=417';
