...
} from '../backup-service.js?v=229';
import { describeDownloadMethod } from '../download.js?v=229';
...
import { forceAppUpdate, checkForAppUpdate, detectRemoteVersion, isStandaloneApp } from '../sw-register.js?v=229';
