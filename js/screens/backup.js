...
} from '../backup-service.js?v=283';
import { describeDownloadMethod } from '../download.js?v=283';
import { showToast, escapeHtml } from '../utils.js?v=283';
import { openModal, closeModal } from '../modal.js?v=283';
import { APP_VERSION } from '../version.js?v=283';
import { forceAppUpdate, checkForAppUpdate, detectRemoteVersion, isStandaloneApp } from '../sw-register.js?v=283';
