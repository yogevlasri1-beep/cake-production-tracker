...
} from '../backup-service.js?v=317';
import { describeDownloadMethod } from '../download.js?v=317';
import { showToast, escapeHtml } from '../utils.js?v=317';
import { openModal, closeModal } from '../modal.js?v=317';
import { APP_VERSION } from '../version.js?v=317';
import { forceAppUpdate, checkForAppUpdate, detectRemoteVersion, isStandaloneApp } from '../sw-register.js?v=317';
