...
} from '../backup-service.js?v=296';
import { describeDownloadMethod } from '../download.js?v=296';
...
import { forceAppUpdate, checkForAppUpdate, detectRemoteVersion, isStandaloneApp } from '../sw-register.js?v=296';
