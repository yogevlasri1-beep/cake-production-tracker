...
} from '../backup-service.js?v=306';
import { describeDownloadMethod } from '../download.js?v=306';
...
import { forceAppUpdate, checkForAppUpdate, detectRemoteVersion, isStandaloneApp } from '../sw-register.js?v=306';
