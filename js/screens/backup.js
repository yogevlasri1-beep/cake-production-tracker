...
} from '../backup-service.js?v=232';
import { describeDownloadMethod } from '../download.js?v=232';
...
import { forceAppUpdate, checkForAppUpdate, detectRemoteVersion, isStandaloneApp } from '../sw-register.js?v=232';
