...
import { renderTargets } from './targets.js?v=467';
import { renderPurchasingInManager } from './purchasing.js?v=467';
import { forceAppUpdate } from '../sw-register.js?v=467';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=467';
import {
...
} from '../daily-plan-export.js?v=467';
