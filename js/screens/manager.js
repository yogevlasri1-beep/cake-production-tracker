...
import { renderTargets } from './targets.js?v=472';
import { renderPurchasingInManager } from './purchasing.js?v=472';
import { forceAppUpdate } from '../sw-register.js?v=472';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=472';
import {
...
} from '../daily-plan-export.js?v=472';
