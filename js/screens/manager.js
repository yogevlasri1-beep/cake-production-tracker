...
import { renderTargets } from './targets.js?v=308';
import { renderPurchasingInManager } from './purchasing.js?v=308';
import { forceAppUpdate } from '../sw-register.js?v=308';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=308';
import {
...
} from '../daily-plan-export.js?v=308';
