...
import { renderTargets } from './targets.js?v=466';
import { renderPurchasingInManager } from './purchasing.js?v=466';
import { forceAppUpdate } from '../sw-register.js?v=466';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=466';
import {
...
} from '../daily-plan-export.js?v=466';
