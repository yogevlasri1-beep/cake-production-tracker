...
import { renderTargets } from './targets.js?v=321';
import { renderPurchasingInManager } from './purchasing.js?v=321';
import { forceAppUpdate } from '../sw-register.js?v=321';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=321';
import {
...
} from '../daily-plan-export.js?v=321';
