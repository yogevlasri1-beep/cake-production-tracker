...
import { renderTargets } from './targets.js?v=474';
import { renderPurchasingInManager } from './purchasing.js?v=474';
import { forceAppUpdate } from '../sw-register.js?v=474';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=474';
import {
...
} from '../daily-plan-export.js?v=474';
