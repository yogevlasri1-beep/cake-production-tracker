...
import { renderTargets } from './targets.js?v=420';
import { renderPurchasingInManager } from './purchasing.js?v=420';
import { forceAppUpdate } from '../sw-register.js?v=420';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=420';
import {
...
} from '../daily-plan-export.js?v=420';
