...
import { renderTargets } from './targets.js?v=470';
import { renderPurchasingInManager } from './purchasing.js?v=470';
import { forceAppUpdate } from '../sw-register.js?v=470';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=470';
import {
...
} from '../daily-plan-export.js?v=470';
