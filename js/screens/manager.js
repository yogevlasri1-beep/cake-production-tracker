...
import { renderTargets } from './targets.js?v=469';
import { renderPurchasingInManager } from './purchasing.js?v=469';
import { forceAppUpdate } from '../sw-register.js?v=469';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=469';
import {
...
} from '../daily-plan-export.js?v=469';
