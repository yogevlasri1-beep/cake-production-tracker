...
import { renderTargets } from './targets.js?v=460';
import { renderPurchasingInManager } from './purchasing.js?v=460';
import { forceAppUpdate } from '../sw-register.js?v=460';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=460';
import {
...
} from '../daily-plan-export.js?v=460';
