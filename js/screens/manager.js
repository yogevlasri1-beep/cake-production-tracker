...
import { renderTargets } from './targets.js?v=405';
import { renderPurchasingInManager } from './purchasing.js?v=405';
import { forceAppUpdate } from '../sw-register.js?v=405';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=405';
import {
...
} from '../daily-plan-export.js?v=405';
