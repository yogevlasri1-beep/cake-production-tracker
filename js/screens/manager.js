...
import { renderTargets } from './targets.js?v=447';
import { renderPurchasingInManager } from './purchasing.js?v=447';
import { forceAppUpdate } from '../sw-register.js?v=447';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=447';
import {
...
} from '../daily-plan-export.js?v=447';
