...
import { renderTargets } from './targets.js?v=484';
import { renderPurchasingInManager } from './purchasing.js?v=484';
import { forceAppUpdate } from '../sw-register.js?v=484';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=484';
import {
...
} from '../daily-plan-export.js?v=484';
