...
import { renderTargets } from './targets.js?v=471';
import { renderPurchasingInManager } from './purchasing.js?v=471';
import { forceAppUpdate } from '../sw-register.js?v=471';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=471';
import {
...
} from '../daily-plan-export.js?v=471';
