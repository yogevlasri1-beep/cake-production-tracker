...
import { renderTargets } from './targets.js?v=448';
import { renderPurchasingInManager } from './purchasing.js?v=448';
import { forceAppUpdate } from '../sw-register.js?v=448';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=448';
import {
...
} from '../daily-plan-export.js?v=448';
