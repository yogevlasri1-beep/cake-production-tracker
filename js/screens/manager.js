...
import { renderTargets } from './targets.js?v=473';
import { renderPurchasingInManager } from './purchasing.js?v=473';
import { forceAppUpdate } from '../sw-register.js?v=473';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=473';
import {
...
} from '../daily-plan-export.js?v=473';
