...
import { renderTargets } from './targets.js?v=459';
import { renderPurchasingInManager } from './purchasing.js?v=459';
import { forceAppUpdate } from '../sw-register.js?v=459';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=459';
import {
...
} from '../daily-plan-export.js?v=459';
