...
import { renderTargets } from './targets.js?v=446';
import { renderPurchasingInManager } from './purchasing.js?v=446';
import { forceAppUpdate } from '../sw-register.js?v=446';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=446';
import {
...
} from '../daily-plan-export.js?v=446';
