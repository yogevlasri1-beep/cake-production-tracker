...
import { renderTargets } from './targets.js?v=463';
import { renderPurchasingInManager } from './purchasing.js?v=463';
import { forceAppUpdate } from '../sw-register.js?v=463';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=463';
import {
...
} from '../daily-plan-export.js?v=463';
