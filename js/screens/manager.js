...
import { renderTargets } from './targets.js?v=485';
import { renderPurchasingInManager } from './purchasing.js?v=485';
import { forceAppUpdate } from '../sw-register.js?v=485';
import { bindFlowChecklistDragLists, bindImprovementDragLists } from '../product-drag.js?v=485';
import {
...
} from '../daily-plan-export.js?v=485';
