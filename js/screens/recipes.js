...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=359';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=359';
import { renderRecipesMachines } from '../recipes-machines.js?v=359';
import { renderRecipesPortions } from '../recipes-portions.js?v=359';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=359';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=359';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=359';
import { openModal, closeModal } from '../modal.js?v=359';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=359';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=359');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=359');
