...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=335';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=335';
import { renderRecipesMachines } from '../recipes-machines.js?v=335';
import { renderRecipesPortions } from '../recipes-portions.js?v=335';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=335';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=335';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=335';
import { openModal, closeModal } from '../modal.js?v=335';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=335';
import { defaultColorForIndex } from '../chart.js?v=335';
