...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=388';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=388';
import { renderRecipesMachines } from '../recipes-machines.js?v=388';
import { renderRecipesPortions } from '../recipes-portions.js?v=388';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=388';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=388';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=388';
import { openModal, closeModal } from '../modal.js?v=388';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=388';
import { defaultColorForIndex } from '../chart.js?v=388';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=388');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=388');
