...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=455';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=455';
import { renderRecipesMachines } from '../recipes-machines.js?v=455';
import { renderRecipesPortions } from '../recipes-portions.js?v=455';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=455';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=455';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=455';
import { openModal, closeModal } from '../modal.js?v=455';
import { getCurrentUserRole } from '../auth.js?v=455';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=455';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=455';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=455');
