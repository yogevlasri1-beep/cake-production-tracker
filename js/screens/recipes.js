...
} from '../kitchen-db.js?v=428';
import { getProducts, getProductsCatalogLayout } from '../db.js?v=428';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=428';
import { renderRecipesMachines } from '../recipes-machines.js?v=428';
import { renderRecipesPortions } from '../recipes-portions.js?v=428';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=428';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=428';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=428';
import { openModal, closeModal } from '../modal.js?v=428';
import { getCurrentUserRole } from '../auth.js?v=428';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=428';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=428';
import { defaultColorForIndex } from '../chart.js?v=428';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=428');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=428');
