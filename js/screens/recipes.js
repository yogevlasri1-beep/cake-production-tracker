...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=396';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=396';
import { renderRecipesMachines } from '../recipes-machines.js?v=396';
import { renderRecipesPortions } from '../recipes-portions.js?v=396';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=396';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=396';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=396';
import { openModal, closeModal } from '../modal.js?v=396';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=396';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=396');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=396');
