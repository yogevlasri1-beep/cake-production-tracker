...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=389';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=389';
import { renderRecipesMachines } from '../recipes-machines.js?v=389';
import { renderRecipesPortions } from '../recipes-portions.js?v=389';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=389';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=389';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=389';
import { openModal, closeModal } from '../modal.js?v=389';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=389';
import { defaultColorForIndex } from '../chart.js?v=389';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=389');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=389');
