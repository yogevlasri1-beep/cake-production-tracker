...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=358';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=358';
import { renderRecipesMachines } from '../recipes-machines.js?v=358';
import { renderRecipesPortions } from '../recipes-portions.js?v=358';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=358';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=358';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=358';
import { openModal, closeModal } from '../modal.js?v=358';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=358';
import { defaultColorForIndex } from '../chart.js?v=358';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=358');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=358');
