...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=216';
import { parseRecipesFromDocxFile, buildRecipeBookHtml } from '../recipe-import.js?v=216';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=216';
import { openModal, closeModal } from '../modal.js?v=216';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=216';
