...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=360';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=360';
import { renderRecipesMachines } from '../recipes-machines.js?v=360';
import { renderRecipesPortions } from '../recipes-portions.js?v=360';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=360';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=360';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=360';
import { openModal, closeModal } from '../modal.js?v=360';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=360';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=360');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=360');
