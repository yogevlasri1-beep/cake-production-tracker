...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=461';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=461';
import { renderRecipesMachines } from '../recipes-machines.js?v=461';
import { renderRecipesPortions } from '../recipes-portions.js?v=461';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=461';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=461';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=461';
import { openModal, closeModal } from '../modal.js?v=461';
import { getCurrentUserRole } from '../auth.js?v=461';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=461';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=461';
import { defaultColorForIndex } from '../chart.js?v=461';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=461');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=461');
