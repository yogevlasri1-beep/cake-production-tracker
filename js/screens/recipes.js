...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=352';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=352';
import { renderRecipesMachines } from '../recipes-machines.js?v=352';
import { renderRecipesPortions } from '../recipes-portions.js?v=352';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=352';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=352';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=352';
import { openModal, closeModal } from '../modal.js?v=352';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=352';
import { defaultColorForIndex } from '../chart.js?v=352';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=352');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=352');
