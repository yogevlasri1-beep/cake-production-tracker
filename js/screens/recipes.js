...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=399';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=399';
import { renderRecipesMachines } from '../recipes-machines.js?v=399';
import { renderRecipesPortions } from '../recipes-portions.js?v=399';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=399';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=399';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=399';
import { openModal, closeModal } from '../modal.js?v=399';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=399';
import { defaultColorForIndex } from '../chart.js?v=399';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=399');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=399');
