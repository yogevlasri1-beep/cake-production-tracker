...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=482';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=482';
import { renderRecipesMachines } from '../recipes-machines.js?v=482';
import { renderRecipesPortions } from '../recipes-portions.js?v=482';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=482';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=482';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=482';
import { openModal, closeModal } from '../modal.js?v=482';
import { getCurrentUserRole } from '../auth.js?v=482';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=482';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=482';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=482');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=482');
