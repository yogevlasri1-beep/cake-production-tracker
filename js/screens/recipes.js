...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=394';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=394';
import { renderRecipesMachines } from '../recipes-machines.js?v=394';
import { renderRecipesPortions } from '../recipes-portions.js?v=394';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=394';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=394';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=394';
import { openModal, closeModal } from '../modal.js?v=394';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=394';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=394');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=394');
