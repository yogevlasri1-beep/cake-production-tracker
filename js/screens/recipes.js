...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=391';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=391';
import { renderRecipesMachines } from '../recipes-machines.js?v=391';
import { renderRecipesPortions } from '../recipes-portions.js?v=391';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=391';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=391';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=391';
import { openModal, closeModal } from '../modal.js?v=391';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=391';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=391');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=391');
