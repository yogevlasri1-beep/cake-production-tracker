...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=270';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=270';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=270';
import { openModal, closeModal } from '../modal.js?v=270';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=270';
