...
} from '../kitchen-db.js?v=357';
import { getProducts, getProductsCatalogLayout } from '../db.js?v=357';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=357';
import { renderRecipesMachines } from '../recipes-machines.js?v=357';
import { renderRecipesPortions } from '../recipes-portions.js?v=357';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=357';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=357';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=357';
import { openModal, closeModal } from '../modal.js?v=357';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=357';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=357');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=357');
