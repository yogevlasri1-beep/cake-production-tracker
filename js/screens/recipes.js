...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=457';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=457';
import { renderRecipesMachines } from '../recipes-machines.js?v=457';
import { renderRecipesPortions } from '../recipes-portions.js?v=457';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=457';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=457';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=457';
import { openModal, closeModal } from '../modal.js?v=457';
import { getCurrentUserRole } from '../auth.js?v=457';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=457';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=457';
import { defaultColorForIndex } from '../chart.js?v=457';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=457');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=457');
