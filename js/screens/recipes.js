...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=459';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=459';
import { renderRecipesMachines } from '../recipes-machines.js?v=459';
import { renderRecipesPortions } from '../recipes-portions.js?v=459';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=459';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=459';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=459';
import { openModal, closeModal } from '../modal.js?v=459';
import { getCurrentUserRole } from '../auth.js?v=459';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=459';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=459';
import { defaultColorForIndex } from '../chart.js?v=459';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=459');
