...
} from '../kitchen-db.js?v=356';
import { getProducts, getProductsCatalogLayout } from '../db.js?v=356';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=356';
import { renderRecipesMachines } from '../recipes-machines.js?v=356';
import { renderRecipesPortions } from '../recipes-portions.js?v=356';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=356';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=356';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=356';
import { openModal, closeModal } from '../modal.js?v=356';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=356';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=356');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=356');
