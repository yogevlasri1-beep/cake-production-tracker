...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=299';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=299';
import { renderRecipesMachines } from '../recipes-machines.js?v=299';
import { renderRecipesPortions } from '../recipes-portions.js?v=299';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=299';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=299';
import { openModal, closeModal } from '../modal.js?v=299';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=299';
