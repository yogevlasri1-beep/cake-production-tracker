...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=300';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=300';
import { renderRecipesMachines } from '../recipes-machines.js?v=300';
import { renderRecipesPortions } from '../recipes-portions.js?v=300';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=300';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=300';
import { openModal, closeModal } from '../modal.js?v=300';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=300';
import { defaultColorForIndex } from '../chart.js?v=300';
