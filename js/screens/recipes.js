...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=458';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=458';
import { renderRecipesMachines } from '../recipes-machines.js?v=458';
import { renderRecipesPortions } from '../recipes-portions.js?v=458';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=458';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=458';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=458';
import { openModal, closeModal } from '../modal.js?v=458';
import { getCurrentUserRole } from '../auth.js?v=458';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=458';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=458';
import { defaultColorForIndex } from '../chart.js?v=458';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=458');
