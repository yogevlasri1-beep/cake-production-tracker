...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=472';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=472';
import { renderRecipesMachines } from '../recipes-machines.js?v=472';
import { renderRecipesPortions } from '../recipes-portions.js?v=472';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=472';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=472';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=472';
import { openModal, closeModal } from '../modal.js?v=472';
import { getCurrentUserRole } from '../auth.js?v=472';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=472';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=472';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=472');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=472');
