...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=392';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=392';
import { renderRecipesMachines } from '../recipes-machines.js?v=392';
import { renderRecipesPortions } from '../recipes-portions.js?v=392';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=392';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=392';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=392';
import { openModal, closeModal } from '../modal.js?v=392';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=392';
import { defaultColorForIndex } from '../chart.js?v=392';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=392');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=392');
