...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=334';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, renderRecipeBookItemHTML } from '../recipe-import.js?v=334';
import { renderRecipesMachines } from '../recipes-machines.js?v=334';
import { renderRecipesPortions } from '../recipes-portions.js?v=334';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=334';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=334';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=334';
import { openModal, closeModal } from '../modal.js?v=334';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=334';
import { defaultColorForIndex } from '../chart.js?v=334';
