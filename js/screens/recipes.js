...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=411';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=411';
import { renderRecipesMachines } from '../recipes-machines.js?v=411';
import { renderRecipesPortions } from '../recipes-portions.js?v=411';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=411';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=411';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=411';
import { openModal, closeModal } from '../modal.js?v=411';
import { getCurrentUserRole } from '../auth.js?v=411';
import { canAccessRecipeTab, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=411';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=411';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=411');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=411');
