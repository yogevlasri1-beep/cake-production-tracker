...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=468';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=468';
import { renderRecipesMachines } from '../recipes-machines.js?v=468';
import { renderRecipesPortions } from '../recipes-portions.js?v=468';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=468';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=468';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=468';
import { openModal, closeModal } from '../modal.js?v=468';
import { getCurrentUserRole } from '../auth.js?v=468';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=468';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=468';
import { defaultColorForIndex } from '../chart.js?v=468';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=468');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=468');
