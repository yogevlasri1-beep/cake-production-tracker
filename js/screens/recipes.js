...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=384';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=384';
import { renderRecipesMachines } from '../recipes-machines.js?v=384';
import { renderRecipesPortions } from '../recipes-portions.js?v=384';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=384';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=384';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=384';
import { openModal, closeModal } from '../modal.js?v=384';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=384';
import { defaultColorForIndex } from '../chart.js?v=384';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=384');
    requestOpenSupplierMaterial(mat.id);
    const { navigateToWorkspace } = await import('../app.js?v=384');
