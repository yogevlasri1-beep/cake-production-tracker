...
import { getProducts, getProductsCatalogLayout } from '../db.js?v=454';
import { parseRecipesFromDocxFile, buildRecipeBookHtml, buildRecipeBookTocHTML, renderRecipeBookItemHTML } from '../recipe-import.js?v=454';
import { renderRecipesMachines } from '../recipes-machines.js?v=454';
import { renderRecipesPortions } from '../recipes-portions.js?v=454';
import { buildRatioPrintHtml, printRatioHtml } from '../ratio-print.js?v=454';
import { buildBakingPrintHtml, shareBakingHtml } from '../baking-print.js?v=454';
import { escapeHtml, showToast, formatMoney } from '../utils.js?v=454';
import { openModal, closeModal } from '../modal.js?v=454';
import { getCurrentUserRole } from '../auth.js?v=454';
import { canAccessRecipeTab, canEditRecipes, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=454';
import {
  bindRecipeDragLists, bindCategoryDragList, bindCategoryGroupDragList,
} from '../product-drag.js?v=454';
...
async function openIngredientMaterialInSuppliers(mat) {
  ...
  try {
    const { requestOpenSupplierMaterial } = await import('./suppliers.js?v=454');
