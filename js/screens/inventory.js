import { escapeHtml, showToast, formatDateTime, weekStartISO, todayISO } from '../utils.js?v=438';
...
} from '../inventory-db.js?v=438';
import { getSupplierCategories } from '../kitchen-db.js?v=438';
import { getCurrentUserRole } from '../auth.js?v=438';
import { canAdjustInventory, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=438';
