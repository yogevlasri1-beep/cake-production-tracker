import { escapeHtml, showToast, formatDateTime, weekStartISO, todayISO } from '../utils.js?v=439';
...
} from '../inventory-db.js?v=439';
import { getSupplierCategories } from '../kitchen-db.js?v=439';
import { getCurrentUserRole } from '../auth.js?v=439';
import { canAdjustInventory, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=439';
