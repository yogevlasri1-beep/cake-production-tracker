...
import { formatMoney, showToast, escapeHtml, productUnitLabel, productPriceUnitLabel, formatDecimal } from '../utils.js?v=374';
import { openModal, closeModal } from '../modal.js?v=374';
import { CATEGORY_COLOR_HEX, defaultColorForIndex } from '../chart.js?v=374';
import { bindProductDragLists, bindCategoryDragList, bindCategoryGroupDragList } from '../product-drag.js?v=374';
