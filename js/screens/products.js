...
import { formatMoney, showToast, escapeHtml, productUnitLabel, productPriceUnitLabel } from '../utils.js?v=154';
import { openModal, closeModal } from '../modal.js?v=154';
import { CATEGORY_COLOR_HEX, defaultColorForIndex } from '../chart.js?v=154';
import { bindProductDragLists, bindCategoryDragList, bindCategoryGroupDragList } from '../product-drag.js?v=154';
import { renderSheetsStatusHTML, bindSheetsStatusEvents } from '../sheets-flow.js?v=154';
...
export async function renderProducts(container) {
  ...
  document.getElementById('open-backup-screen')?.addEventListener('click', async () => {
    const { navigate } = await import('../app.js?v=154');
    navigate('backup');
  });
