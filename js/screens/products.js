...
import { formatMoney, showToast, escapeHtml, productUnitLabel, productPriceUnitLabel } from '../utils.js?v=117';
import { openModal, closeModal } from '../modal.js?v=117';
import { CATEGORY_COLOR_HEX, defaultColorForIndex } from '../chart.js?v=117';
import { bindProductDragLists, bindCategoryDragList, bindCategoryGroupDragList } from '../product-drag.js?v=117';
...
export async function renderProducts(container) {
  ...
  document.getElementById('open-backup-screen')?.addEventListener('click', async () => {
    const { navigate } = await import('../app.js?v=117');
    navigate('backup');
  });
