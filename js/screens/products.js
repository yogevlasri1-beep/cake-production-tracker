...
import { formatMoney, showToast, escapeHtml, productUnitLabel, productPriceUnitLabel } from '../utils.js?v=132';
import { openModal, closeModal } from '../modal.js?v=132';
import { CATEGORY_COLOR_HEX, defaultColorForIndex } from '../chart.js?v=132';
import { bindProductDragLists, bindCategoryDragList, bindCategoryGroupDragList } from '../product-drag.js?v=132';
import { renderSheetsStatusHTML, bindSheetsStatusEvents } from '../sheets-flow.js?v=132';
...
export async function renderProducts(container) {
  ...
  document.getElementById('open-backup-screen')?.addEventListener('click', async () => {
    const { navigate } = await import('../app.js?v=132');
    navigate('backup');
  });
