import { getCategoryGroups } from '../db.js?v=477';
import { escapeHtml, showToast, todayISO, formatDateHebrew } from '../utils.js?v=477';
import { openModal, closeModal } from '../modal.js?v=477';
import { printHaccpPlan } from '../haccp-print.js?v=477';
import { getCurrentUserRole } from '../auth.js?v=477';
import { canAccessHaccpStep, PERMISSION_DENIED_MESSAGE } from '../permissions.js?v=477';
import {
  HACCP_STEPS,
  HACCP_PRP_TOPICS,
  HACCP_PRP_STATUSES,
