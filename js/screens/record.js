...
import { todayISO, formatDate, showToast, escapeHtml, productUnitLabel, formatProductQuantity, productRecordUsesKg, formatDecimal } from '../utils.js?v=429';
...
import { getRecipeForProduct, recipeScaleRatioForProductCount } from '../kitchen-db.js?v=429';
