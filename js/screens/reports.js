...
} from '../sheets-flow.js?v=132';
import { isSheetsConfigured } from '../google-sheets.js?v=132';
import { buildProductMap, sumCategoryTotals, productProductionValue, productProductionCost, mapGetById, sortProductsForReport } from '../calc.js?v=132';
import { defaultColorForIndex } from '../chart.js?v=132';
import { saveReportPageAsHtml, printReportElement } from '../report-page-export.js?v=132';
