...
} from '../sheets-flow.js?v=118';
import { isSheetsConfigured } from '../google-sheets.js?v=118';
import { buildProductMap, sumCategoryTotals, productProductionValue, productProductionCost, mapGetById, sortProductsForReport } from '../calc.js?v=118';
import { defaultColorForIndex } from '../chart.js?v=118';
import { saveReportPageAsHtml, printReportElement } from '../report-page-export.js?v=118';
