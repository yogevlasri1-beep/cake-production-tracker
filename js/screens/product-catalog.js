...
import { getProductDetail } from '../kitchen-db.js?v=447';
import { getCurrentUserRole } from '../auth.js?v=447';
import { canManageProductCatalog } from '../permissions.js?v=447';
import {
...
} from '../product-catalog.js?v=447';
import {
  exportProductCatalogHtml,
  exportProductCatalogExcel,
} from '../product-catalog-export.js?v=447';
