...
import { getProductDetail } from '../kitchen-db.js?v=448';
import { getCurrentUserRole } from '../auth.js?v=448';
import { canManageProductCatalog } from '../permissions.js?v=448';
import {
...
} from '../product-catalog.js?v=448';
import {
  exportProductCatalogHtml,
  exportProductCatalogExcel,
} from '../product-catalog-export.js?v=448';
