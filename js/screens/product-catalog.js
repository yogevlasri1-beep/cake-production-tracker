...
import { getProductDetail } from '../kitchen-db.js?v=467';
import { getCurrentUserRole } from '../auth.js?v=467';
import { canManageProductCatalog } from '../permissions.js?v=467';
import {
...
} from '../product-catalog.js?v=467';
import {
  exportProductCatalogHtml,
  exportProductCatalogExcel,
} from '../product-catalog-export.js?v=467';
