import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=414';
import { getProducts, getCategories } from '../db.js?v=414';
import {
...
} from '../supplier-import.js?v=414';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=414';
import { openModal, closeModal } from '../modal.js?v=414';
import { requestAutoBackupNow } from '../backup-service.js?v=414';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=414';
