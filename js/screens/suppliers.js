import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=410';
import { getProducts, getCategories } from '../db.js?v=410';
import {
...
} from '../supplier-import.js?v=410';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=410';
import { openModal, closeModal } from '../modal.js?v=410';
import { requestAutoBackupNow } from '../backup-service.js?v=410';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=410';
