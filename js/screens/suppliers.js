...
import { getProducts } from '../db.js?v=296';
import { parseSupplierFile } from '../supplier-import.js?v=296';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=296';
import { openModal, closeModal } from '../modal.js?v=296';
import { requestAutoBackupNow } from '../backup-service.js?v=296';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=296';
