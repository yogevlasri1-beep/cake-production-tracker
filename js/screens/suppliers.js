import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=408';
import { getProducts, getCategories } from '../db.js?v=408';
import {
...
} from '../supplier-import.js?v=408';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=408';
import { openModal, closeModal } from '../modal.js?v=408';
import { requestAutoBackupNow } from '../backup-service.js?v=408';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=408';
