import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=378';
import { getProducts, getCategories } from '../db.js?v=378';
import { parseSupplierFile } from '../supplier-import.js?v=378';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=378';
import { openModal, closeModal } from '../modal.js?v=378';
import { requestAutoBackupNow } from '../backup-service.js?v=378';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=378';
