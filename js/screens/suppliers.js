import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=392';
import { getProducts, getCategories } from '../db.js?v=392';
import {
...
} from '../supplier-import.js?v=392';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=392';
import { openModal, closeModal } from '../modal.js?v=392';
import { requestAutoBackupNow } from '../backup-service.js?v=392';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=392';
