import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=379';
import { getProducts, getCategories } from '../db.js?v=379';
import { parseSupplierFile } from '../supplier-import.js?v=379';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=379';
import { openModal, closeModal } from '../modal.js?v=379';
import { requestAutoBackupNow } from '../backup-service.js?v=379';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=379';
