import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=416';
import { getProducts, getCategories } from '../db.js?v=416';
import {
...
} from '../supplier-import.js?v=416';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=416';
import { openModal, closeModal } from '../modal.js?v=416';
import { requestAutoBackupNow } from '../backup-service.js?v=416';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=416';
