...
import { getProducts } from '../db.js?v=346';
import { parseSupplierFile } from '../supplier-import.js?v=346';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=346';
import { openModal, closeModal } from '../modal.js?v=346';
import { requestAutoBackupNow } from '../backup-service.js?v=346';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=346';
