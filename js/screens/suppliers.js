import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=402';
import { getProducts, getCategories } from '../db.js?v=402';
import {
...
} from '../supplier-import.js?v=402';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=402';
import { openModal, closeModal } from '../modal.js?v=402';
import { requestAutoBackupNow } from '../backup-service.js?v=402';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=402';
