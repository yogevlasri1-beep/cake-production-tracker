import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=375';
import { getProducts, getCategories } from '../db.js?v=375';
import { parseSupplierFile } from '../supplier-import.js?v=375';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=375';
import { openModal, closeModal } from '../modal.js?v=375';
import { requestAutoBackupNow } from '../backup-service.js?v=375';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=375';
