import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=400';
import { getProducts, getCategories } from '../db.js?v=400';
import {
...
} from '../supplier-import.js?v=400';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=400';
import { openModal, closeModal } from '../modal.js?v=400';
import { requestAutoBackupNow } from '../backup-service.js?v=400';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=400';
