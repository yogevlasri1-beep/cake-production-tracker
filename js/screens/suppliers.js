import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=401';
import { getProducts, getCategories } from '../db.js?v=401';
import {
...
} from '../supplier-import.js?v=401';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=401';
import { openModal, closeModal } from '../modal.js?v=401';
import { requestAutoBackupNow } from '../backup-service.js?v=401';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=401';
