import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=415';
import { getProducts, getCategories } from '../db.js?v=415';
import {
...
} from '../supplier-import.js?v=415';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=415';
import { openModal, closeModal } from '../modal.js?v=415';
import { requestAutoBackupNow } from '../backup-service.js?v=415';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=415';
