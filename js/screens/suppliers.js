import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=389';
import { getProducts, getCategories } from '../db.js?v=389';
import {
...
} from '../supplier-import.js?v=389';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=389';
import { openModal, closeModal } from '../modal.js?v=389';
import { requestAutoBackupNow } from '../backup-service.js?v=389';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=389';
