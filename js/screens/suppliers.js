import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=390';
import { getProducts, getCategories } from '../db.js?v=390';
import {
...
} from '../supplier-import.js?v=390';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=390';
import { openModal, closeModal } from '../modal.js?v=390';
import { requestAutoBackupNow } from '../backup-service.js?v=390';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=390';
