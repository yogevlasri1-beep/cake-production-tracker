...
import { getProducts, getCategories } from '../db.js?v=409';
import {
...
} from '../supplier-import.js?v=409';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=409';
import { openModal, closeModal } from '../modal.js?v=409';
import { requestAutoBackupNow } from '../backup-service.js?v=409';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=409';
