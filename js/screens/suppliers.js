import {
  ...
  applyPackagingLinks,
} from '../kitchen-db.js?v=391';
import { getProducts, getCategories } from '../db.js?v=391';
import {
...
} from '../supplier-import.js?v=391';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=391';
import { openModal, closeModal } from '../modal.js?v=391';
import { requestAutoBackupNow } from '../backup-service.js?v=391';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=391';
