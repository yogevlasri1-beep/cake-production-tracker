...
import { getProducts } from '../db.js?v=304';
import { parseSupplierFile } from '../supplier-import.js?v=304';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=304';
import { openModal, closeModal } from '../modal.js?v=304';
import { requestAutoBackupNow } from '../backup-service.js?v=304';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=304';
