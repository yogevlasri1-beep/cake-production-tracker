...
import { getProducts } from '../db.js?v=274';
import { parseSupplierFile } from '../supplier-import.js?v=274';
import { escapeHtml, showToast, formatMoney, weekStartISO, formatDate, todayISO } from '../utils.js?v=274';
import { openModal, closeModal } from '../modal.js?v=274';
import { requestAutoBackupNow } from '../backup-service.js?v=274';
import { bindSupplierDragList, bindMaterialDragList } from '../product-drag.js?v=274';
