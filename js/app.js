import { initDB } from './db.js?v=390';
import { renderHome, homeMeta } from './screens/home.js?v=390';
import { renderProducts, productsMeta } from './screens/products.js?v=390';
import { renderManager, managerMeta } from './screens/manager.js?v=390';
import { renderProcess, processMeta } from './screens/process.js?v=390';
import { renderReports, reportsMeta } from './screens/reports.js?v=390';
import { renderBackup, backupMeta } from './screens/backup.js?v=390';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=390';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=390';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=390';
import { initIOSInstallPrompt } from './ios-install.js?v=390';
import { initNetworkCheck } from './network.js?v=390';
import { registerServiceWorker } from './sw-register.js?v=390';
import { APP_VERSION } from './version.js?v=390';
import { showToast } from './utils.js?v=390';
import './modal.js?v=390';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=390');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=390').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=390');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=390');
