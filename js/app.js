import { initDB } from './db.js?v=247';
import { renderHome, homeMeta } from './screens/home.js?v=247';
import { renderProducts, productsMeta } from './screens/products.js?v=247';
import { renderManager, managerMeta } from './screens/manager.js?v=247';
import { renderProcess, processMeta } from './screens/process.js?v=247';
import { renderReports, reportsMeta } from './screens/reports.js?v=247';
import { renderBackup, backupMeta } from './screens/backup.js?v=247';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=247';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=247';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=247';
import { initIOSInstallPrompt } from './ios-install.js?v=247';
import { initNetworkCheck } from './network.js?v=247';
import { registerServiceWorker } from './sw-register.js?v=247';
import { APP_VERSION } from './version.js?v=247';
import { showToast } from './utils.js?v=247';
import './modal.js?v=247';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=247');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=247').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=247');
