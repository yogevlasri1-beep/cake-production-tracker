import { initDB } from './db.js?v=361';
import { renderHome, homeMeta } from './screens/home.js?v=361';
import { renderProducts, productsMeta } from './screens/products.js?v=361';
import { renderManager, managerMeta } from './screens/manager.js?v=361';
import { renderProcess, processMeta } from './screens/process.js?v=361';
import { renderReports, reportsMeta } from './screens/reports.js?v=361';
import { renderBackup, backupMeta } from './screens/backup.js?v=361';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=361';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=361';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=361';
import { initIOSInstallPrompt } from './ios-install.js?v=361';
import { initNetworkCheck } from './network.js?v=361';
import { registerServiceWorker } from './sw-register.js?v=361';
import { APP_VERSION } from './version.js?v=361';
import { showToast } from './utils.js?v=361';
import './modal.js?v=361';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=361');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=361').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=361');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=361');
