import { initDB } from './db.js?v=248';
import { renderHome, homeMeta } from './screens/home.js?v=248';
import { renderProducts, productsMeta } from './screens/products.js?v=248';
import { renderManager, managerMeta } from './screens/manager.js?v=248';
import { renderProcess, processMeta } from './screens/process.js?v=248';
import { renderReports, reportsMeta } from './screens/reports.js?v=248';
import { renderBackup, backupMeta } from './screens/backup.js?v=248';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=248';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=248';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=248';
import { initIOSInstallPrompt } from './ios-install.js?v=248';
import { initNetworkCheck } from './network.js?v=248';
import { registerServiceWorker } from './sw-register.js?v=248';
import { APP_VERSION } from './version.js?v=248';
import { showToast } from './utils.js?v=248';
import './modal.js?v=248';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=248');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=248').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=248');
