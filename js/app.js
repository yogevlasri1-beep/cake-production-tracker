import { initDB } from './db.js?v=169';
import { renderHome, homeMeta } from './screens/home.js?v=169';
import { renderProducts, productsMeta } from './screens/products.js?v=169';
import { renderManager, managerMeta } from './screens/manager.js?v=169';
import { renderProcess, processMeta } from './screens/process.js?v=169';
import { renderReports, reportsMeta } from './screens/reports.js?v=169';
import { renderBackup, backupMeta } from './screens/backup.js?v=169';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=169';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=169';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=169';
import { initIOSInstallPrompt } from './ios-install.js?v=169';
import { initNetworkCheck } from './network.js?v=169';
import { registerServiceWorker } from './sw-register.js?v=169';
import { APP_VERSION } from './version.js?v=169';
import { showToast } from './utils.js?v=169';
import './modal.js?v=169';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=169');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=169').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=169');
