import { initDB } from './db.js?v=166';
import { renderHome, homeMeta } from './screens/home.js?v=166';
import { renderProducts, productsMeta } from './screens/products.js?v=166';
import { renderManager, managerMeta } from './screens/manager.js?v=166';
import { renderProcess, processMeta } from './screens/process.js?v=166';
import { renderReports, reportsMeta } from './screens/reports.js?v=166';
import { renderBackup, backupMeta } from './screens/backup.js?v=166';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=166';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=166';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=166';
import { initIOSInstallPrompt } from './ios-install.js?v=166';
import { initNetworkCheck } from './network.js?v=166';
import { registerServiceWorker } from './sw-register.js?v=166';
import { APP_VERSION } from './version.js?v=166';
import { showToast } from './utils.js?v=166';
import './modal.js?v=166';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=166');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=166').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=166');
