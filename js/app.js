import { initDB } from './db.js?v=205';
import { renderHome, homeMeta } from './screens/home.js?v=205';
import { renderProducts, productsMeta } from './screens/products.js?v=205';
import { renderManager, managerMeta } from './screens/manager.js?v=205';
import { renderProcess, processMeta } from './screens/process.js?v=205';
import { renderReports, reportsMeta } from './screens/reports.js?v=205';
import { renderBackup, backupMeta } from './screens/backup.js?v=205';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=205';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=205';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=205';
import { initIOSInstallPrompt } from './ios-install.js?v=205';
import { initNetworkCheck } from './network.js?v=205';
import { registerServiceWorker } from './sw-register.js?v=205';
import { APP_VERSION } from './version.js?v=205';
import { showToast } from './utils.js?v=205';
import './modal.js?v=205';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=205');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=205').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=205');
