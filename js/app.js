import { initDB } from './db.js?v=375';
import { renderHome, homeMeta } from './screens/home.js?v=375';
import { renderProducts, productsMeta } from './screens/products.js?v=375';
import { renderManager, managerMeta } from './screens/manager.js?v=375';
import { renderProcess, processMeta } from './screens/process.js?v=375';
import { renderReports, reportsMeta } from './screens/reports.js?v=375';
import { renderBackup, backupMeta } from './screens/backup.js?v=375';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=375';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=375';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=375';
import { initIOSInstallPrompt } from './ios-install.js?v=375';
import { initNetworkCheck } from './network.js?v=375';
import { registerServiceWorker } from './sw-register.js?v=375';
import { APP_VERSION } from './version.js?v=375';
import { showToast } from './utils.js?v=375';
import './modal.js?v=375';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=375');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=375').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=375');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=375');
