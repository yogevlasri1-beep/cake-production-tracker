import { initDB } from './db.js?v=376';
import { renderHome, homeMeta } from './screens/home.js?v=376';
import { renderProducts, productsMeta } from './screens/products.js?v=376';
import { renderManager, managerMeta } from './screens/manager.js?v=376';
import { renderProcess, processMeta } from './screens/process.js?v=376';
import { renderReports, reportsMeta } from './screens/reports.js?v=376';
import { renderBackup, backupMeta } from './screens/backup.js?v=376';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=376';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=376';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=376';
import { initIOSInstallPrompt } from './ios-install.js?v=376';
import { initNetworkCheck } from './network.js?v=376';
import { registerServiceWorker } from './sw-register.js?v=376';
import { APP_VERSION } from './version.js?v=376';
import { showToast } from './utils.js?v=376';
import './modal.js?v=376';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=376');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=376').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=376');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=376');
