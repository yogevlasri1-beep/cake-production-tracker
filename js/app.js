import { initDB } from './db.js?v=158';
import { renderHome, homeMeta } from './screens/home.js?v=158';
import { renderProducts, productsMeta } from './screens/products.js?v=158';
import { renderManager, managerMeta } from './screens/manager.js?v=158';
import { renderProcess, processMeta } from './screens/process.js?v=158';
import { renderReports, reportsMeta } from './screens/reports.js?v=158';
import { renderBackup, backupMeta } from './screens/backup.js?v=158';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=158';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=158';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=158';
import { initIOSInstallPrompt } from './ios-install.js?v=158';
import { initNetworkCheck } from './network.js?v=158';
import { registerServiceWorker } from './sw-register.js?v=158';
import { APP_VERSION } from './version.js?v=158';
import { showToast } from './utils.js?v=158';
import './modal.js?v=158';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=158');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=158').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=158');
