import { initDB } from './db.js?v=363';
import { renderHome, homeMeta } from './screens/home.js?v=363';
import { renderProducts, productsMeta } from './screens/products.js?v=363';
import { renderManager, managerMeta } from './screens/manager.js?v=363';
import { renderProcess, processMeta } from './screens/process.js?v=363';
import { renderReports, reportsMeta } from './screens/reports.js?v=363';
import { renderBackup, backupMeta } from './screens/backup.js?v=363';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=363';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=363';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=363';
import { initIOSInstallPrompt } from './ios-install.js?v=363';
import { initNetworkCheck } from './network.js?v=363';
import { registerServiceWorker } from './sw-register.js?v=363';
import { APP_VERSION } from './version.js?v=363';
import { showToast } from './utils.js?v=363';
import './modal.js?v=363';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=363');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=363').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=363');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=363');
