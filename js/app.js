import { initDB } from './db.js?v=159';
import { renderHome, homeMeta } from './screens/home.js?v=159';
import { renderProducts, productsMeta } from './screens/products.js?v=159';
import { renderManager, managerMeta } from './screens/manager.js?v=159';
import { renderProcess, processMeta } from './screens/process.js?v=159';
import { renderReports, reportsMeta } from './screens/reports.js?v=159';
import { renderBackup, backupMeta } from './screens/backup.js?v=159';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=159';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=159';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=159';
import { initIOSInstallPrompt } from './ios-install.js?v=159';
import { initNetworkCheck } from './network.js?v=159';
import { registerServiceWorker } from './sw-register.js?v=159';
import { APP_VERSION } from './version.js?v=159';
import { showToast } from './utils.js?v=159';
import './modal.js?v=159';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=159');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=159').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=159');
