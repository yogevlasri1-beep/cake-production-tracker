import { initDB } from './db.js?v=377';
import { renderHome, homeMeta } from './screens/home.js?v=377';
import { renderProducts, productsMeta } from './screens/products.js?v=377';
import { renderManager, managerMeta } from './screens/manager.js?v=377';
import { renderProcess, processMeta } from './screens/process.js?v=377';
import { renderReports, reportsMeta } from './screens/reports.js?v=377';
import { renderBackup, backupMeta } from './screens/backup.js?v=377';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=377';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=377';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=377';
import { initIOSInstallPrompt } from './ios-install.js?v=377';
import { initNetworkCheck } from './network.js?v=377';
import { registerServiceWorker } from './sw-register.js?v=377';
import { APP_VERSION } from './version.js?v=377';
import { showToast } from './utils.js?v=377';
import './modal.js?v=377';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=377');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=377').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=377');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=377');
