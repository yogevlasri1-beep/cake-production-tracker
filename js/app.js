import { initDB } from './db.js?v=220';
import { renderHome, homeMeta } from './screens/home.js?v=220';
import { renderProducts, productsMeta } from './screens/products.js?v=220';
import { renderManager, managerMeta } from './screens/manager.js?v=220';
import { renderProcess, processMeta } from './screens/process.js?v=220';
import { renderReports, reportsMeta } from './screens/reports.js?v=220';
import { renderBackup, backupMeta } from './screens/backup.js?v=220';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=220';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=220';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=220';
import { initIOSInstallPrompt } from './ios-install.js?v=220';
import { initNetworkCheck } from './network.js?v=220';
import { registerServiceWorker } from './sw-register.js?v=220';
import { APP_VERSION } from './version.js?v=220';
import { showToast } from './utils.js?v=220';
import './modal.js?v=220';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=220');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=220').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=220');
