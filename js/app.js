import { initDB } from './db.js?v=290';
import { renderHome, homeMeta } from './screens/home.js?v=290';
import { renderProducts, productsMeta } from './screens/products.js?v=290';
import { renderManager, managerMeta } from './screens/manager.js?v=290';
import { renderProcess, processMeta } from './screens/process.js?v=290';
import { renderReports, reportsMeta } from './screens/reports.js?v=290';
import { renderBackup, backupMeta } from './screens/backup.js?v=290';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=290';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=290';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=290';
import { initIOSInstallPrompt } from './ios-install.js?v=290';
import { initNetworkCheck } from './network.js?v=290';
import { registerServiceWorker } from './sw-register.js?v=290';
import { APP_VERSION } from './version.js?v=290';
import { showToast } from './utils.js?v=290';
import './modal.js?v=290';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=290');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=290').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=290');
