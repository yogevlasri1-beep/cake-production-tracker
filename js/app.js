import { initDB } from './db.js?v=203';
import { renderHome, homeMeta } from './screens/home.js?v=203';
import { renderProducts, productsMeta } from './screens/products.js?v=203';
import { renderManager, managerMeta } from './screens/manager.js?v=203';
import { renderProcess, processMeta } from './screens/process.js?v=203';
import { renderReports, reportsMeta } from './screens/reports.js?v=203';
import { renderBackup, backupMeta } from './screens/backup.js?v=203';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=203';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=203';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=203';
import { initIOSInstallPrompt } from './ios-install.js?v=203';
import { initNetworkCheck } from './network.js?v=203';
import { registerServiceWorker } from './sw-register.js?v=203';
import { APP_VERSION } from './version.js?v=203';
import { showToast } from './utils.js?v=203';
import './modal.js?v=203';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=203');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=203').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=203');
