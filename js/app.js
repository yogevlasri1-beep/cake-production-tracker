import { initDB } from './db.js?v=171';
import { renderHome, homeMeta } from './screens/home.js?v=171';
import { renderProducts, productsMeta } from './screens/products.js?v=171';
import { renderManager, managerMeta } from './screens/manager.js?v=171';
import { renderProcess, processMeta } from './screens/process.js?v=171';
import { renderReports, reportsMeta } from './screens/reports.js?v=171';
import { renderBackup, backupMeta } from './screens/backup.js?v=171';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=171';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=171';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=171';
import { initIOSInstallPrompt } from './ios-install.js?v=171';
import { initNetworkCheck } from './network.js?v=171';
import { registerServiceWorker } from './sw-register.js?v=171';
import { APP_VERSION } from './version.js?v=171';
import { showToast } from './utils.js?v=171';
import './modal.js?v=171';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=171');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=171').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=171');
