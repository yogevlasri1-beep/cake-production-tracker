import { initDB } from './db.js?v=154';
import { renderHome, homeMeta } from './screens/home.js?v=154';
import { renderProducts, productsMeta } from './screens/products.js?v=154';
import { renderManager, managerMeta } from './screens/manager.js?v=154';
import { renderProcess, processMeta } from './screens/process.js?v=154';
import { renderReports, reportsMeta } from './screens/reports.js?v=154';
import { renderBackup, backupMeta } from './screens/backup.js?v=154';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=154';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=154';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=154';
import { initIOSInstallPrompt } from './ios-install.js?v=154';
import { initNetworkCheck } from './network.js?v=154';
import { registerServiceWorker } from './sw-register.js?v=154';
import { APP_VERSION } from './version.js?v=154';
import { showToast } from './utils.js?v=154';
import './modal.js?v=154';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=154');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=154').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=154');
