import { initDB } from './db.js?v=319';
import { renderHome, homeMeta } from './screens/home.js?v=319';
import { renderProducts, productsMeta } from './screens/products.js?v=319';
import { renderManager, managerMeta } from './screens/manager.js?v=319';
import { renderProcess, processMeta } from './screens/process.js?v=319';
import { renderReports, reportsMeta } from './screens/reports.js?v=319';
import { renderBackup, backupMeta } from './screens/backup.js?v=319';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=319';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=319';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=319';
import { initIOSInstallPrompt } from './ios-install.js?v=319';
import { initNetworkCheck } from './network.js?v=319';
import { registerServiceWorker } from './sw-register.js?v=319';
import { APP_VERSION } from './version.js?v=319';
import { showToast } from './utils.js?v=319';
import './modal.js?v=319';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=319');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=319').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=319');
