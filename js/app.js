import { initDB } from './db.js?v=360';
import { renderHome, homeMeta } from './screens/home.js?v=360';
import { renderProducts, productsMeta } from './screens/products.js?v=360';
import { renderManager, managerMeta } from './screens/manager.js?v=360';
import { renderProcess, processMeta } from './screens/process.js?v=360';
import { renderReports, reportsMeta } from './screens/reports.js?v=360';
import { renderBackup, backupMeta } from './screens/backup.js?v=360';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=360';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=360';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=360';
import { initIOSInstallPrompt } from './ios-install.js?v=360';
import { initNetworkCheck } from './network.js?v=360';
import { registerServiceWorker } from './sw-register.js?v=360';
import { APP_VERSION } from './version.js?v=360';
import { showToast } from './utils.js?v=360';
import './modal.js?v=360';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=360');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=360').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=360');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=360');
