import { initDB } from './db.js?v=313';
import { renderHome, homeMeta } from './screens/home.js?v=313';
import { renderProducts, productsMeta } from './screens/products.js?v=313';
import { renderManager, managerMeta } from './screens/manager.js?v=313';
import { renderProcess, processMeta } from './screens/process.js?v=313';
import { renderReports, reportsMeta } from './screens/reports.js?v=313';
import { renderBackup, backupMeta } from './screens/backup.js?v=313';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=313';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=313';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=313';
import { initIOSInstallPrompt } from './ios-install.js?v=313';
import { initNetworkCheck } from './network.js?v=313';
import { registerServiceWorker } from './sw-register.js?v=313';
import { APP_VERSION } from './version.js?v=313';
import { showToast } from './utils.js?v=313';
import './modal.js?v=313';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=313');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=313').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=313');
