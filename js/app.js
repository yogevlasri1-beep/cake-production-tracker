import { initDB } from './db.js?v=204';
import { renderHome, homeMeta } from './screens/home.js?v=204';
import { renderProducts, productsMeta } from './screens/products.js?v=204';
import { renderManager, managerMeta } from './screens/manager.js?v=204';
import { renderProcess, processMeta } from './screens/process.js?v=204';
import { renderReports, reportsMeta } from './screens/reports.js?v=204';
import { renderBackup, backupMeta } from './screens/backup.js?v=204';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=204';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=204';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=204';
import { initIOSInstallPrompt } from './ios-install.js?v=204';
import { initNetworkCheck } from './network.js?v=204';
import { registerServiceWorker } from './sw-register.js?v=204';
import { APP_VERSION } from './version.js?v=204';
import { showToast } from './utils.js?v=204';
import './modal.js?v=204';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=204');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=204').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=204');
