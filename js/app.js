import { initDB } from './db.js?v=173';
import { renderHome, homeMeta } from './screens/home.js?v=173';
import { renderProducts, productsMeta } from './screens/products.js?v=173';
import { renderManager, managerMeta } from './screens/manager.js?v=173';
import { renderProcess, processMeta } from './screens/process.js?v=173';
import { renderReports, reportsMeta } from './screens/reports.js?v=173';
import { renderBackup, backupMeta } from './screens/backup.js?v=173';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=173';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=173';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=173';
import { initIOSInstallPrompt } from './ios-install.js?v=173';
import { initNetworkCheck } from './network.js?v=173';
import { registerServiceWorker } from './sw-register.js?v=173';
import { APP_VERSION } from './version.js?v=173';
import { showToast } from './utils.js?v=173';
import './modal.js?v=173';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=173');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=173').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=173');
