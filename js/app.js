import { initDB } from './db.js?v=180';
import { renderHome, homeMeta } from './screens/home.js?v=180';
import { renderProducts, productsMeta } from './screens/products.js?v=180';
import { renderManager, managerMeta } from './screens/manager.js?v=180';
import { renderProcess, processMeta } from './screens/process.js?v=180';
import { renderReports, reportsMeta } from './screens/reports.js?v=180';
import { renderBackup, backupMeta } from './screens/backup.js?v=180';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=180';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=180';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=180';
import { initIOSInstallPrompt } from './ios-install.js?v=180';
import { initNetworkCheck } from './network.js?v=180';
import { registerServiceWorker } from './sw-register.js?v=180';
import { APP_VERSION } from './version.js?v=180';
import { showToast } from './utils.js?v=180';
import './modal.js?v=180';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=180');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=180').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=180');
