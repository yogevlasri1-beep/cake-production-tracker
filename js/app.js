import { initDB } from './db.js?v=223';
import { renderHome, homeMeta } from './screens/home.js?v=223';
import { renderProducts, productsMeta } from './screens/products.js?v=223';
import { renderManager, managerMeta } from './screens/manager.js?v=223';
import { renderProcess, processMeta } from './screens/process.js?v=223';
import { renderReports, reportsMeta } from './screens/reports.js?v=223';
import { renderBackup, backupMeta } from './screens/backup.js?v=223';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=223';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=223';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=223';
import { initIOSInstallPrompt } from './ios-install.js?v=223';
import { initNetworkCheck } from './network.js?v=223';
import { registerServiceWorker } from './sw-register.js?v=223';
import { APP_VERSION } from './version.js?v=223';
import { showToast } from './utils.js?v=223';
import './modal.js?v=223';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=223');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=223').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=223');
