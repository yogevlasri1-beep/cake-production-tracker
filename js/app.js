import { initDB } from './db.js?v=379';
import { renderHome, homeMeta } from './screens/home.js?v=379';
import { renderProducts, productsMeta } from './screens/products.js?v=379';
import { renderManager, managerMeta } from './screens/manager.js?v=379';
import { renderProcess, processMeta } from './screens/process.js?v=379';
import { renderReports, reportsMeta } from './screens/reports.js?v=379';
import { renderBackup, backupMeta } from './screens/backup.js?v=379';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=379';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=379';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=379';
import { initIOSInstallPrompt } from './ios-install.js?v=379';
import { initNetworkCheck } from './network.js?v=379';
import { registerServiceWorker } from './sw-register.js?v=379';
import { APP_VERSION } from './version.js?v=379';
import { showToast } from './utils.js?v=379';
import './modal.js?v=379';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=379');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=379').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=379');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=379');
