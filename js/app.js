import { initDB } from './db.js?v=212';
import { renderHome, homeMeta } from './screens/home.js?v=212';
import { renderProducts, productsMeta } from './screens/products.js?v=212';
import { renderManager, managerMeta } from './screens/manager.js?v=212';
import { renderProcess, processMeta } from './screens/process.js?v=212';
import { renderReports, reportsMeta } from './screens/reports.js?v=212';
import { renderBackup, backupMeta } from './screens/backup.js?v=212';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=212';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=212';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=212';
import { initIOSInstallPrompt } from './ios-install.js?v=212';
import { initNetworkCheck } from './network.js?v=212';
import { registerServiceWorker } from './sw-register.js?v=212';
import { APP_VERSION } from './version.js?v=212';
import { showToast } from './utils.js?v=212';
import './modal.js?v=212';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=212');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=212').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=212');
