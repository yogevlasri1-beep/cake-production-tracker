import { initDB } from './db.js?v=172';
import { renderHome, homeMeta } from './screens/home.js?v=172';
import { renderProducts, productsMeta } from './screens/products.js?v=172';
import { renderManager, managerMeta } from './screens/manager.js?v=172';
import { renderProcess, processMeta } from './screens/process.js?v=172';
import { renderReports, reportsMeta } from './screens/reports.js?v=172';
import { renderBackup, backupMeta } from './screens/backup.js?v=172';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=172';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=172';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=172';
import { initIOSInstallPrompt } from './ios-install.js?v=172';
import { initNetworkCheck } from './network.js?v=172';
import { registerServiceWorker } from './sw-register.js?v=172';
import { APP_VERSION } from './version.js?v=172';
import { showToast } from './utils.js?v=172';
import './modal.js?v=172';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=172');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=172').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=172');
