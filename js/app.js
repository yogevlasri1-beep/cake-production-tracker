import { initDB } from './db.js?v=129';
import { renderHome, homeMeta } from './screens/home.js?v=129';
import { renderProducts, productsMeta } from './screens/products.js?v=129';
import { renderManager, managerMeta } from './screens/manager.js?v=129';
import { renderProcess, processMeta } from './screens/process.js?v=129';
import { renderReports, reportsMeta } from './screens/reports.js?v=129';
import { renderBackup, backupMeta } from './screens/backup.js?v=129';
import { renderRecipes, recipesMeta } from './screens/recipes.js?v=129';
import { renderSuppliers, suppliersMeta } from './screens/suppliers.js?v=129';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=129';
import { initIOSInstallPrompt } from './ios-install.js?v=129';
import { initNetworkCheck } from './network.js?v=129';
import { registerServiceWorker } from './sw-register.js?v=129';
import { APP_VERSION } from './version.js?v=129';
import { showToast } from './utils.js?v=129';
import './modal.js?v=129';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=129');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=129').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=129');
