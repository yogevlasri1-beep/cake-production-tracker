import { initDB } from './db.js?v=380';
import { renderHome, homeMeta } from './screens/home.js?v=380';
import { renderProducts, productsMeta } from './screens/products.js?v=380';
import { renderManager, managerMeta } from './screens/manager.js?v=380';
import { renderProcess, processMeta } from './screens/process.js?v=380';
import { renderReports, reportsMeta } from './screens/reports.js?v=380';
import { renderBackup, backupMeta } from './screens/backup.js?v=380';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=380';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=380';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=380';
import { initIOSInstallPrompt } from './ios-install.js?v=380';
import { initNetworkCheck } from './network.js?v=380';
import { registerServiceWorker } from './sw-register.js?v=380';
import { APP_VERSION } from './version.js?v=380';
import { showToast } from './utils.js?v=380';
import './modal.js?v=380';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=380');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=380').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=380');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=380');
