import { initDB } from './db.js?v=324';
import { renderHome, homeMeta } from './screens/home.js?v=324';
import { renderProducts, productsMeta } from './screens/products.js?v=324';
import { renderManager, managerMeta } from './screens/manager.js?v=324';
import { renderProcess, processMeta } from './screens/process.js?v=324';
import { renderReports, reportsMeta } from './screens/reports.js?v=324';
import { renderBackup, backupMeta } from './screens/backup.js?v=324';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=324';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=324';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=324';
import { initIOSInstallPrompt } from './ios-install.js?v=324';
import { initNetworkCheck } from './network.js?v=324';
import { registerServiceWorker } from './sw-register.js?v=324';
import { APP_VERSION } from './version.js?v=324';
import { showToast } from './utils.js?v=324';
import './modal.js?v=324';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=324');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=324').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=324');
