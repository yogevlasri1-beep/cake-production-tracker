import { initDB } from './db.js?v=157';
import { renderHome, homeMeta } from './screens/home.js?v=157';
import { renderProducts, productsMeta } from './screens/products.js?v=157';
import { renderManager, managerMeta } from './screens/manager.js?v=157';
import { renderProcess, processMeta } from './screens/process.js?v=157';
import { renderReports, reportsMeta } from './screens/reports.js?v=157';
import { renderBackup, backupMeta } from './screens/backup.js?v=157';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=157';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=157';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=157';
import { initIOSInstallPrompt } from './ios-install.js?v=157';
import { initNetworkCheck } from './network.js?v=157';
import { registerServiceWorker } from './sw-register.js?v=157';
import { APP_VERSION } from './version.js?v=157';
import { showToast } from './utils.js?v=157';
import './modal.js?v=157';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=157');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=157').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=157');
