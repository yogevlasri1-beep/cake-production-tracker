import { initDB } from './db.js?v=122';
import { renderHome, homeMeta } from './screens/home.js?v=122';
import { renderProducts, productsMeta } from './screens/products.js?v=122';
import { renderManager, managerMeta } from './screens/manager.js?v=122';
import { renderProcess, processMeta } from './screens/process.js?v=122';
import { renderReports, reportsMeta } from './screens/reports.js?v=122';
import { renderBackup, backupMeta } from './screens/backup.js?v=122';
import { initIOSInstallPrompt } from './ios-install.js?v=122';
import { initNetworkCheck } from './network.js?v=122';
import { registerServiceWorker } from './sw-register.js?v=122';
import { APP_VERSION } from './version.js?v=122';
import { showToast } from './utils.js?v=122';
import './modal.js?v=122';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=122');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=122').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=122');
