import { initDB } from './db.js?v=317';
import { renderHome, homeMeta } from './screens/home.js?v=317';
import { renderProducts, productsMeta } from './screens/products.js?v=317';
import { renderManager, managerMeta } from './screens/manager.js?v=317';
import { renderProcess, processMeta } from './screens/process.js?v=317';
import { renderReports, reportsMeta } from './screens/reports.js?v=317';
import { renderBackup, backupMeta } from './screens/backup.js?v=317';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=317';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=317';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=317';
import { initIOSInstallPrompt } from './ios-install.js?v=317';
import { initNetworkCheck } from './network.js?v=317';
import { registerServiceWorker } from './sw-register.js?v=317';
import { APP_VERSION } from './version.js?v=317';
import { showToast } from './utils.js?v=317';
import './modal.js?v=317';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=317');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=317').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=317');
