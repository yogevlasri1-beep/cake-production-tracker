import { initDB } from './db.js?v=249';
import { renderHome, homeMeta } from './screens/home.js?v=249';
import { renderProducts, productsMeta } from './screens/products.js?v=249';
import { renderManager, managerMeta } from './screens/manager.js?v=249';
import { renderProcess, processMeta } from './screens/process.js?v=249';
import { renderReports, reportsMeta } from './screens/reports.js?v=249';
import { renderBackup, backupMeta } from './screens/backup.js?v=249';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=249';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=249';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=249';
import { initIOSInstallPrompt } from './ios-install.js?v=249';
import { initNetworkCheck } from './network.js?v=249';
import { registerServiceWorker } from './sw-register.js?v=249';
import { APP_VERSION } from './version.js?v=249';
import { showToast } from './utils.js?v=249';
import './modal.js?v=249';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=249');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=249').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=249');
