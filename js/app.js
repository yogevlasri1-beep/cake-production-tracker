import { initDB } from './db.js?v=400';
import { renderHome, homeMeta } from './screens/home.js?v=400';
import { renderProducts, productsMeta } from './screens/products.js?v=400';
import { renderManager, managerMeta } from './screens/manager.js?v=400';
import { renderProcess, processMeta } from './screens/process.js?v=400';
import { renderReports, reportsMeta } from './screens/reports.js?v=400';
import { renderBackup, backupMeta } from './screens/backup.js?v=400';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=400';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=400';
import { renderHaccp, haccpMeta } from './screens/haccp.js?v=400';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=400';
import { initIOSInstallPrompt } from './ios-install.js?v=400';
import { initNetworkCheck } from './network.js?v=400';
import { registerServiceWorker } from './sw-register.js?v=400';
import { APP_VERSION } from './version.js?v=400';
import { showToast } from './utils.js?v=400';
import './modal.js?v=400';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=400');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=400').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=400');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=400');
