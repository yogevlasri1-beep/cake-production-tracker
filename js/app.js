import { initDB } from './db.js?v=357';
import { renderHome, homeMeta } from './screens/home.js?v=357';
import { renderProducts, productsMeta } from './screens/products.js?v=357';
import { renderManager, managerMeta } from './screens/manager.js?v=357';
import { renderProcess, processMeta } from './screens/process.js?v=357';
import { renderReports, reportsMeta } from './screens/reports.js?v=357';
import { renderBackup, backupMeta } from './screens/backup.js?v=357';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=357';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=357';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=357';
import { initIOSInstallPrompt } from './ios-install.js?v=357';
import { initNetworkCheck } from './network.js?v=357';
import { registerServiceWorker } from './sw-register.js?v=357';
import { APP_VERSION } from './version.js?v=357';
import { showToast } from './utils.js?v=357';
import './modal.js?v=357';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=357');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=357').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=357');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=357');
