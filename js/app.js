import { initDB } from './db.js?v=378';
import { renderHome, homeMeta } from './screens/home.js?v=378';
import { renderProducts, productsMeta } from './screens/products.js?v=378';
import { renderManager, managerMeta } from './screens/manager.js?v=378';
import { renderProcess, processMeta } from './screens/process.js?v=378';
import { renderReports, reportsMeta } from './screens/reports.js?v=378';
import { renderBackup, backupMeta } from './screens/backup.js?v=378';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=378';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=378';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=378';
import { initIOSInstallPrompt } from './ios-install.js?v=378';
import { initNetworkCheck } from './network.js?v=378';
import { registerServiceWorker } from './sw-register.js?v=378';
import { APP_VERSION } from './version.js?v=378';
import { showToast } from './utils.js?v=378';
import './modal.js?v=378';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=378');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=378').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=378');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=378');
