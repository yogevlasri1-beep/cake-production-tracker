import { initDB } from './db.js?v=184';
import { renderHome, homeMeta } from './screens/home.js?v=184';
import { renderProducts, productsMeta } from './screens/products.js?v=184';
import { renderManager, managerMeta } from './screens/manager.js?v=184';
import { renderProcess, processMeta } from './screens/process.js?v=184';
import { renderReports, reportsMeta } from './screens/reports.js?v=184';
import { renderBackup, backupMeta } from './screens/backup.js?v=184';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=184';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=184';
import { getSavedWorkspace, saveWorkspace, WORKSPACES } from './workspaces.js?v=184';
import { initIOSInstallPrompt } from './ios-install.js?v=184';
import { initNetworkCheck } from './network.js?v=184';
import { registerServiceWorker } from './sw-register.js?v=184';
import { APP_VERSION } from './version.js?v=184';
import { showToast } from './utils.js?v=184';
import './modal.js?v=184';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=184');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=184').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=184');
