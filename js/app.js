import { initDB } from './db.js?v=362';
import { renderHome, homeMeta } from './screens/home.js?v=362';
import { renderProducts, productsMeta } from './screens/products.js?v=362';
import { renderManager, managerMeta } from './screens/manager.js?v=362';
import { renderProcess, processMeta } from './screens/process.js?v=362';
import { renderReports, reportsMeta } from './screens/reports.js?v=362';
import { renderBackup, backupMeta } from './screens/backup.js?v=362';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=362';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=362';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=362';
import { initIOSInstallPrompt } from './ios-install.js?v=362';
import { initNetworkCheck } from './network.js?v=362';
import { registerServiceWorker } from './sw-register.js?v=362';
import { APP_VERSION } from './version.js?v=362';
import { showToast } from './utils.js?v=362';
import './modal.js?v=362';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=362');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=362').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=362');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=362');
