import { initDB } from './db.js?v=391';
import { renderHome, homeMeta } from './screens/home.js?v=391';
import { renderProducts, productsMeta } from './screens/products.js?v=391';
import { renderManager, managerMeta } from './screens/manager.js?v=391';
import { renderProcess, processMeta } from './screens/process.js?v=391';
import { renderReports, reportsMeta } from './screens/reports.js?v=391';
import { renderBackup, backupMeta } from './screens/backup.js?v=391';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=391';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=391';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=391';
import { initIOSInstallPrompt } from './ios-install.js?v=391';
import { initNetworkCheck } from './network.js?v=391';
import { registerServiceWorker } from './sw-register.js?v=391';
import { APP_VERSION } from './version.js?v=391';
import { showToast } from './utils.js?v=391';
import './modal.js?v=391';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=391');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=391').then(async ({ detectRemoteVersion }) => {
    ...
    } = await import('./supabase-sync.js?v=391');
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=391');
