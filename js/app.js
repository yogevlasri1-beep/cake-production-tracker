import { initDB } from './db.js?v=310';
import { renderHome, homeMeta } from './screens/home.js?v=310';
import { renderProducts, productsMeta } from './screens/products.js?v=310';
import { renderManager, managerMeta } from './screens/manager.js?v=310';
import { renderProcess, processMeta } from './screens/process.js?v=310';
import { renderReports, reportsMeta } from './screens/reports.js?v=310';
import { renderBackup, backupMeta } from './screens/backup.js?v=310';
import { renderRecipes, recipesMeta, initRecipesSubNav } from './screens/recipes.js?v=310';
import { renderSuppliers, suppliersMeta, initSuppliersSubNav } from './screens/suppliers.js?v=310';
import { getSavedWorkspace, saveWorkspace, WORKSPACES, MANAGER_TAB_KEY } from './workspaces.js?v=310';
import { initIOSInstallPrompt } from './ios-install.js?v=310';
import { initNetworkCheck } from './network.js?v=310';
import { registerServiceWorker } from './sw-register.js?v=310';
import { APP_VERSION } from './version.js?v=310';
import { showToast } from './utils.js?v=310';
import './modal.js?v=310';
  ...
  try {
    ...
    if (versionEl) {
      ...
      versionEl.addEventListener('click', async () => {
        const { forceAppUpdate } = await import('./sw-register.js?v=310');
        showToast('מעדכן...');
        await forceAppUpdate();
      });
      import('./sw-register.js?v=310').then(async ({ detectRemoteVersion }) => {
    ...
    const { initAutoBackupSystem, promptRestoreIfNeeded } = await import('./backup-service.js?v=310');
