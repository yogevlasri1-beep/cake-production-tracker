...
} from '../js/calc.js?v=122';
import { parseDate, parseQuantity, detectAndParse, parseImportFile } from '../js/import.js?v=122';
import { enrichBackupData } from '../js/backup.js?v=122';
