...
import { shouldApplyRemote, orderedCollections, COLLECTION_TABLE, SYNC_ORDER, isSyncCollection, rowFingerprint, rowDedupeFingerprint, POLYMORPHIC_FKS } from '../js/sync/collections.js?v=483';
...
export async function runAllTests() {
  ...
  test('rowDedupeFingerprint — רישומי ייצור מתעלמים מ-runId', () => {
    ...
    assertEqual(withRun, 'productionEntries|2026-07-21|5|1050|0');
    assertEqual(
